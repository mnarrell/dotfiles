...
if exists('$SUDO_USER')
  ...
  set backupdir=$XDG_DATA_HOME/vim/backup    " keep backup files out of the way
  set backupdir+=.
endif
...
if has('viminfo')
  if exists('$SUDO_USER')
    ...
    set viminfo='1000,n$XDG_DATA_HOME/vim/viminfo " override ~/.viminfo default

    if !empty(glob('$XDG_DATA_HOME/vim/viminfo'))
      if !filereadable(expand('$XDG_DATA_HOME/vim/viminfo'))
        echoerr 'warning: $XDG_DATA_HOME/vim/viminfo exists but is not readable'
      endif
    endif
  endif
endif
...
if exists('$SUDO_USER')
  ...
  set directory=$XDG_DATA_HOME/vim/swap    " keep swap files out of the way
  set directory+=.
endif
