...
vim.wo.relativenumber = true                         -- show relative numbers in gutter
vim.wo.signcolumn = 'yes'                            -- Always show the gutter
vim.wo.wrap = false                                  -- Do not wrap lines by default
...
vim.o.updatetime = 2000                             -- same as YCM
